...
public class Renderer {
	...
	public PImage[] loadImagesSeperatedBy(int pixels,String path) {
		...
		for(int i = 0; i < imageLength; i++) {
			subimages[i] = img.get(i*pixels, 0, pixels, img.height);
		}
		return subimages;
	}
